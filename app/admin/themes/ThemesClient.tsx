...
export function ThemesClient({
  ...
  return (
    <div className="relative space-y-12 p-2">
      {/* BACKDROP AURA */}
      ...
      {/* ======================================================
          SECTION 1: TEMPLATES (NEW)
          ====================================================== */}
      <section>
        <TemplateSelector initialTemplate={initialTemplate} />
      </section>
      ...
      {/* ======================================================
          SECTION 2: THEMES (EXISTING PRESERVED)
          ====================================================== */}
      <section className="space-y-6">
        <div className="flex items-center gap-3">
          <span className="h-3 w-3 rounded-full bg-orange-500 shrink-0" />
          <h2 className="text-xl font-semibold text-white">Card Picture & Themes</h2>
        </div>
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5 text-xs transition-all duration-300">
            ...
            {saveStatus === "saved" && (
              <span className="text-emerald-400/80 font-medium">✓ Saved</span>
            )}
            {saveStatus === "error" && (
